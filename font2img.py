...
parser.add_argument('--src_font', default='1.ttf', help='path of the source font')
parser.add_argument('--fonts_dir', default='fonts', help='dir path of the target fonts')
parser.add_argument('--filter', type=int, default=1, help='filter recurring characters')
parser.add_argument('--charset', type=str, default='KR',
...
parser.add_argument('--sample_dir', default='paired_images', help='directory to save examples')
